 ...
 */
int model_m1(instance *inst, CPXENVptr env, CPXLPptr lp, int counter, char **cname) {
    ...
    for (int t = 0; t < inst->T; t++) {
        ...
        double lb = 0.0;
        double ub = P;
        double obj = powerCostTimet(t+1, inst) * 1/1000;     // la potenza dev'essere espressa in kWh
